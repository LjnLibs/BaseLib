...
public class  MyMultiItemFetchLoadAdapter<T extends BaseData> extends BaseMultiItemFetchLoadAdapter<T, BaseViewHolder>{

    private Map<Class<? extends BaseMulitItemHolder>, Integer> holder2ViewType;

    public MyMultiItemFetchLoadAdapter(RecyclerView recyclerView, List<T> data, List<MulitItemBean> holderList) {
